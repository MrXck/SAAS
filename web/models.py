...
class Project(models.Model):
    ...
    bucket = models.CharField(verbose_name='腾讯对象存储槽', max_length=128)
    region = models.CharField(verbose_name='腾讯对象存储槽区域', max_length=32)
...
class FileRepository(models.Model):
    ...
    file_path = models.CharField(verbose_name='文件路径', max_length=400, null=True)
    ...
    parent = models.ForeignKey(verbose_name='父目录', to='FileRepository', null=True, blank=True, related_name='child')
...
class Issues(models.Model):
    ...
    parent = models.ForeignKey(verbose_name='父问题', to='Issues', related_name='child', null=True, blank=True, on_delete=models.SET_NULL)
...
class IssuesReply(models.Model):
    ...
    create_datetime = models.DateTimeField(verbose_name='创建时间', auto_now_add=True)
    reply = models.ForeignKey(verbose_name='回复', to='IssuesReply', null=True, blank=True)
